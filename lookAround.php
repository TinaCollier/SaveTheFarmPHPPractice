  ...
  if ($wearing_contacts xor $wearing_glasses) {
    switch($location) {
      case "kitchen":
        ...
        $moved_cupboard ? "The cupboard has been moved aside, and reveals a safe built into the wall. \n" : "Also, there's a conspicuously large cupboard against a peculiar worn piece of the wall.\n";
        break;
      case "bathroom":
